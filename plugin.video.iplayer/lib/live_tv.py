...
def fetch_stream_info(channel, bitrate, req_provider):
    ...
    # bbc one switched to "akamai_hd" instead of "akamai" (29/04/2011 - beg/05/2011, 10/08/2011 - )
    if ( channel == "bbc_one_london" or channel == channel == "bbc_two_england" ) and req_provider == "akamai":
